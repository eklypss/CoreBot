...
namespace CoreBot.Settings
{
    ...
    public static class DefaultValues
    {
        ...
        public const string FMI_SEARCH_API =
            "http://ilmatieteenlaitos.fi/etusivu?p_p_id=locationmenuportlet_WAR_fmiwwwweatherportlets&p_p_lifecycle=2&term=";
        ...
        public const string AZURE_VISION_URL = "https://westus.api.cognitive.microsoft.com/vision/v1.0/analyze?visualFeatures=Description";
        ...
        public static char DEFAULT_SEPARATOR_CHAR { get; set; } = '|';
